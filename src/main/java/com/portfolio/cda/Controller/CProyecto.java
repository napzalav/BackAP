...
import com.portfolio.cda.Dto.dtoProyecto;
import com.portfolio.cda.Entity.Proyecto;
import com.portfolio.cda.Security.Controller.Mensaje;
import com.portfolio.cda.Service.SProyecto;
...
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproyecto){
        ...
        Proyecto proyecto = new Proyecto(dtoproyecto.getNombreP(), dtoproyecto.getDescripcionP(), dtoproyecto.getImg(), dtoproyecto.getPagina(), dtoproyecto.getRepositorio());
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproyecto){
        ...
        if (sProyecto.existsByNombreP(dtoproyecto.getNombreP()))
          ...
          Proyecto proyecto = new Proyecto(dtoproyecto.getDescripcionP(), dtoproyecto.getDescripcionP());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyecto dtoproyecto) {
        ...
        proyecto.setPagina(dtoproyecto.getPagina());
